! function(e, t) {
    ...
    function k(e) {
        var t = ht,
            n = Zt[e];
        return n || (n = C(e, t), "none" !== n && n || (Qt = (Qt || it("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement), t = (Qt[0].contentWindow || Qt[0].contentDocument).document, t.write(), t.close(), n = C(e, t), Qt.detach()), Zt[e] = n), n
    }
    ...
    var ut = function(e) {
        ...
        function p(e, t, n) {
            ...
            return t.first ? function(t, n, o) {
                ...
                if (a) {
                    ...
                    for (; t = t[r];)
                        if (1 === t.nodeType || i) {
                            if (l = t[B] || (t[B] = {}), (s = l[r]) && s[0] === $ && s[1] === o) return u[2] = s[2];
        ...
        var x, w, T, E, C, k, N, S, j, A, D, L, H, _, q, F, M, O, R, B = "sizzle" + -new Date,
            P = e.document,
            $ = 0,
            I = 0,
            W = n(),
        ...
        w = t.support = {}, C = t.isXML = function(e) {
            ...
            var t, n = e ? e.ownerDocument || e : P,
                r = n.defaultView;
            return n !== H && 9 === n.nodeType && n.documentElement ? (H = n, _ = n.documentElement, q = !C(n), r && r !== r.top && (r.addEventListener ? r.addEventListener("unload", function() {
                L()
                    ...
                    return 1 === r && 0 === i ? function(e) {
                        ...
                        if (g) {
                            ...
                            if (h = [a ? g.firstChild : g.lastChild], a && y) {
                                for (c = g[B] || (g[B] = {}), u = c[e] || [], p = u[0] === $ && u[1], f = u[0] === $ && u[2], d = p && g.childNodes[p]; d = ++p && d && d[m] || (f = p = 0) || h.pop();)
                                    if (1 === d.nodeType && ++f && d === t) {
                                        c[e] = [$, p, f];
                                        break
                                    }
                            } else if (y && (u = (t[B] || (t[B] = {}))[e]) && u[0] === $) f = u[1];
                            else
                                for (;
                                    (d = ++p && d && d[m] || (f = p = 0) || h.pop()) && ((s ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++f || (y && ((d[B] || (d[B] = {}))[e] = [$, f]), d !== t)););
    ...
    nt.ownLast = "0" !== Tt, nt.inlineBlockNeedsLayout = !1, it(function() {
        var e, t, n, r;
        n = ht.getElementsByTagName("body")[0], n && n.style && (t = ht.createElement("div"), r = ht.createElement("div"), r.style.cssText = "position:absolute;border:0;width:0;height:0;top:40px;left:-9999px", n.appendChild(r).appendChild(t), typeof t.style.zoom !== Et && (t.style.cssText = "display:inline;margin:0;border:0;padding:1px;width:1px;zoom:1", nt.inlineBlockNeedsLayout = e = 3 === t.offsetWidth, e && (n.style.zoom = 1)), n.removeChild(r))
    }),
    function() {
    ...
    Yt.optgroup = Yt.option, Yt.tbody = Yt.tfoot = Yt.colgroup = Yt.caption = Yt.thead, Yt.th = Yt.td, it.extend({
        ...
        buildFragment: function(e, t, n, r) {
            for (var i, o, a, s, l, u, c, d = e.length, f = m(t), p = [], h = 0; d > h; h++)
                ...
                for (s = s || f.appendChild(t.createElement("div")), l = ($t.exec(o) || ["", ""])[1].toLowerCase(), c = Yt[l] || Yt._default, s.innerHTML = c[1] + o.replace(Pt, "<$1></$2>") + c[2], i = c[0]; i--;) s = s.lastChild;
        ...
        html: function(e) {
            return At(this, function(e) {
                ...
                if (!("string" != typeof e || zt.test(e) || !nt.htmlSerialize && Rt.test(e) || !nt.leadingWhitespace && Bt.test(e) || Yt[($t.exec(e) || ["", ""])[1].toLowerCase()])) {
                    e = e.replace(Pt, "<$1></$2>");
                    try {
    ...
    function() {
        function t() {
            var t, n, r, i;
            n = ht.getElementsByTagName("body")[0], n && n.style && (t = ht.createElement("div"), r = ht.createElement("div"), r.style.cssText = "position:absolute;border:0;width:0;height:0;top:40px;left:-9999px", n.appendChild(r).appendChild(t), t.style.cssText = "-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;display:block;margin-top:1%;top:1%;border:1px;padding:1px;width:4px;position:absolute", o = a = !1, l = !0, e.getComputedStyle && (o = "1%" !== (e.getComputedStyle(t, null) || {}).top, a = "4px" === (e.getComputedStyle(t, null) || {
                width: "4px"
    ...
    it.fn.extend({
        ...
        Cn[t] = Sn && Nn || !kn.test(t) ? function(e, t, r) {
            var i, o;
    ...
    qn = In.exec(Fn.toLowerCase()) || [], it.extend({
        active: 0,
        lastModified: {},
        etag: {},
        ajaxSettings: {
        ...
        ajaxSetup: function(e, t) {
            return t ? $($(e, it.ajaxSettings), t) : $(it.ajaxSettings, e)
        },
        ajaxPrefilter: B(Wn),
        ajaxTransport: B(zn),
        ajax: function(e, t) {
            ...
            if (h.promise(w).complete = m.add, w.success = w.done, w.error = w.fail, d.url = ((e || d.url || Fn) + "").replace(Mn, "").replace($n, qn[1] + "//"), d.type = t.method || t.type || d.method || d.type, d.dataTypes = it.trim(d.dataType || "*").toLowerCase().match(bt) || [""], null == d.crossDomain && (r = In.exec(d.url.toLowerCase()), d.crossDomain = !(!r || r[1] === qn[1] && r[2] === qn[2] && (r[3] || ("http:" === r[1] ? "80" : "443")) === (qn[3] || ("http:" === qn[1] ? "80" : "443")))), d.data && d.processData && "string" != typeof d.data && (d.data = it.param(d.data, d.traditional)), P(Wn, d, t, w), 2 === b) return w;
...
function() {
    var e, t, n, r, i, o, a, s, l, u, c, d, f, p, h, m, g, v, y, b, x, w, T, E, C, k, N, S, j, A, D, L, H, _, q, F, M, O, R, B, P, $, I, W, z, X, U, V, G, Y = [].indexOf || function(e) {
            for (var t = 0, n = this.length; n > t; t++)
    ...
    j = {}, d = 10, W = !1, m = null, S = null, q = null, h = null, V = null, b = function(e) {
        var t;
        return e = new n(e), B(), c(), F(e), W && (t = z(e.absolute)) ? (x(t), w(e)) : w(e, I)
    }, z = function(e) {
        var t;
        return t = j[e], t && !t.transitionCacheDisabled ? t : void 0
    }, g = function(e) {
        return null == e && (e = !0), W = e
    }, w = function(e, t) {
        return null == t && (t = function() {
            return function() {}
        }(this)), X("page:fetch", {
            url: e.absolute
        }), null != V && V.abort(), V = new XMLHttpRequest, V.open("GET", e.withoutHashForIE10compatibility(), !0), V.setRequestHeader("Accept", "text/html, application/xhtml+xml, application/xml"), V.setRequestHeader("X-XHR-Referer", q), V.onload = function() {
            var n;
            return X("page:receive"), (n = H()) ? (f.apply(null, y(n)), M(), t(), X("page:load")) : document.location.href = e.absolute
        ...
        return null != V && V.abort(), f(e.title, e.body), _(e), X("page:restore")
    }, c = function() {
        var e;
        return e = new n(m.url), j[e.absolute] = {
            url: e.relative,
            body: document.body,
        ...
        var t, n, r, i, o, a;
        for (r = Object.keys(j), t = r.map(function(e) {
            return j[e].cachedAt
        }).sort(function(e, t) {
            return t - e
        }), a = [], i = 0, o = r.length; o > i; i++) n = r[i], j[n].cachedAt <= t[e] && (X("page:expire", j[n]), a.push(delete j[n]));
        return a
    }, f = function(t, n, r, i) {
        return document.title = t, document.documentElement.replaceChild(n, document.body), null != r && e.update(r), i && v(), m = window.history.state, X("page:change"), X("page:update")
    }, v = function() {
        ...
        for (o = Array.prototype.slice.call(document.body.querySelectorAll('script:not([data-turbolinks-eval="false"])')), a = 0, l = o.length; l > a; a++)
            if (i = o[a], "" === (c = i.type) || "text/javascript" === c) {
                for (t = document.createElement("script"), d = i.attributes, s = 0, u = d.length; u > s; s++) e = d[s], t.setAttribute(e.name, e.value);
        ...
        return (e = new n(e)).absolute !== q ? window.history.pushState({
            turbolinks: !0,
            url: e.absolute
        }, "", e.absolute) : void 0
    }, M = function() {
        var e, t;
        return (e = V.getResponseHeader("X-XHR-Redirected-To")) ? (e = new n(e), t = e.hasNoHash() ? document.location.hash : "", window.history.replaceState(m, "", e.href + t)) : void 0
    }, B = function() {
        ...
        return t = function() {
            ...
            var n, r, i, o, a;
            for (e.length > t.length && (o = [t, e], e = o[0], t = o[1]), a = [], r = 0, i = e.length; i > r; r++) n = e[r], Y.call(t, n) >= 0 && a.push(n);
            return a
        }, !t() && o() && (n = h(V.responseText), n && !e(n)) ? n : void 0
    }, y = function(t) {
        var n;
        return n = t.querySelector("title"), [null != n ? n.textContent : void 0, P(t.body), e.get(t).token, "runScripts"]
    }, e = {
        get: function(e) {
            var t;
        ...
        return K(t, e), t.HTML_EXTENSIONS = ["html"], t.allowExtensions = function() {
            var e, n, r, i;
            for (n = 1 <= arguments.length ? Q.call(arguments, 0) : [], r = 0, i = n.length; i > r; r++) e = n[r], t.HTML_EXTENSIONS.push(e);
        ...
        function e(e) {
            this.event = e, this.event.defaultPrevented || (this._extractLink(), this._validForTurbolinks() && (A() || U(this.link.href), this.event.preventDefault()))
        }
        ...
        var t, r;
        return (null != (r = e.state) ? r.turbolinks : void 0) ? (t = j[new n(e.state.url).absolute]) ? (c(), x(t)) : U(e.target.location.href) : void 0
    }, E = function() {
        return R(), O(), h = i(), document.addEventListener("click", t.installHandlerLast, !0), u(function() {
            return window.addEventListener("popstate", k, !1)
        })
    }, T = void 0 !== window.history.state || navigator.userAgent.match(/Firefox\/2[6|7]/), s = window.history && window.history.pushState && window.history.replaceState && T, o = !navigator.userAgent.match(/CriOS\//), $ = "GET" === (G = L("request_method")) || "" === G, l = s && o && $, a = document.addEventListener && document.createEvent, a && (C(), N()), l ? (U = b, E()) : U = function(e) {
...
function() {
    ...
    t = ["most aesthetic", "most prestigious", "most Banatean", "party-animal", "most badass", "way cooler", "better tasting", "really hip", "best dressed", "zestiest", "overly scientific", "beginner friendly", "1337 hax0r", "most dope"], $(function() {
        ...
        var e, t, n, r;
        return r = $("header").outerHeight(), e = r + $("#faq").outerHeight(), n = $(window).scrollTop(), t = $("#numbers"), t.css(n > r && n < e - $(window).height() ? {
            position: "fixed",
            top: '40px',
            left: 0
        } : n > r && e - n < $(window).height() ? {
            position: "relative",
            top: e - r - t.outerHeight()
        } : {
            position: ""
        })
    }, e = function(e, t, n) {
        ...
        function() {
            var o, a, s;
            return o = 1 <= arguments.length ? r.call(arguments, 0) : [], s = this, a = function() {
                return n || e.apply(s, o), i = null
            }, i ? clearTimeout(i) : n && e.apply(s, o), i = setTimeout(a, t || 100)
        }
    }, this.update = function() {
        var e, n, r, i, o;
        return n = $("h2.faded:first-child span"), r = $("h2.primary span"), i = $("h2.faded:last-child span"), e = "webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", o = t.shift(), t.push(o), n.addClass("animated fadeIn").html(t[2]), r.addClass("animated bounceInDown").html(t[1]), i.addClass("animated fadeIn").html(t[0]), setTimeout(function() {
            return update()
        }, 4e3), !0
    }
}.call(this),
